...
public class EnemyScript : MonoBehaviour 
{
    ...
    public float speed; //Speed of the player in percent of distanced traveled per second. e.g. 0.50 is the enemy will move 50% of the way to the player each second.
